  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="/"><i class="fa fa-home"></i><span>Dashboard</span>
        
        <li><a href="/supplies"><i class="fa fa-truck text-warning"></i> <span>Supplies</span>
        <span class="pull-right-container"><small class="label pull-right bg-red">0</small></span></a>
        </li>
        <li class=""><a href="/products"><i class="fa fa-shopping-cart"></i><span>Products</span>
        <span class="pull-right-container"><small class="label pull-right bg-maroon">0</small></span></a>
        </li>
