                ...
                <div class="col-xs-9 col-xs-offset-1">
                    ...
                    {{ csrf_field() }}
                        <div class="form-group">
                            ...
                            <input type="text" name="brand" id="name" class="form-control" required value="{{ $brand->brand }}">
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-center text-danger">Are you sure you want to permanently delete "{{ $brand->brand }}" ?</p>
                    <form action="/brands/{{ $brand->id }}" method="post">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
                        <center>
